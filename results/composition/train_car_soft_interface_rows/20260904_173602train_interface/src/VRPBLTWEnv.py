...
class VRPBLTWEnv:
    ...
    @classmethod
    def _consequence_row(cls, active, state, post, margin, event):
        ...
        row = torch.stack((torch.ones_like(state), cls._soft_bound(state),
                           cls._soft_bound(post), cls._soft_bound(margin),
